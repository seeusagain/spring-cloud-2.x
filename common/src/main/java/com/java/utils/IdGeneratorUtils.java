...
/**
 * Created by lu.xu on 2017/6/21. TODO:id生成器
 */
...
//获取7位随机数
  ...
  /**
   * 获取随7位机数（为避免重复，分别获取4位和3位两组随机数） Math.random()产生一个[0，1)之间的随机double数值，是Java、js等语言常用代码。 例如：var a =
   * Math.random() * 2 + 1，设置一个随机1到3(取不到3)的变量。
   */
